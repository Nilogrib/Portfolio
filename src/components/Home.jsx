...
import { FaSquareFacebook, FaSquareInstagram, FaTwitter, FaX, FaXTwitter, FaGithub } from "react-icons/fa6";
      ...
      >
        <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="  space-y-2">
                ...
                <ul className="flex space-x-5">
                  <li>
                    <a href="https://www.instagram.com/nilogrib.13/" target="_blank">
                      <FaSquareInstagram className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/in/nilogrib/" target="_blank">
                      <FaLinkedin className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://x.com/nilogrib" target="_blank">
                      <FaXTwitter className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/Nilogrib" target="_blank">
          ...
          <div className="md:w-1/2 md:ml-48 md:mt-20 mt-8 order-1">
            <img
              src={pic}
              className="rounded-full md:w-[400px] md:h-[500px]"
              alt=""
            />
          </div>
        </div>
